...
export const BentoGridItem = ({
  ...
  const leftLists = ["ReactJS", "Laravel", "Git"];
  ...
  background: "linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,35,1) 100%)",
    ...
    >
      ...
      <div className={`${id === 2 && "flex justify-center"} h-full min-h-400px`}>
        ...
        </div>
        {
          id === 6 && (
            <BackgroundGradientAnimation>
              <div className="absolute z-50 flex items-center justify-center text-white text-bold"></div>
            </BackgroundGradientAnimation>
          )
        }
