      ...
      <div className="max-w-2xl mx-auto px-6 space-y-4">
        {workExperience.map((exp, idx) => (
          <motion.div
            ...
            className="flex gap-4 bg-linear-to-br from-[#04071d] to-[#0c0e23] rounded-2xl border border-white/8 p-5 hover:border-white/14 transition-all duration-300"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-start justify-between gap-2 flex-wrap">
                ...
                <span className="text-xs font-mono text-white/25 whitespace-nowrap shrink-0 mt-0.5">
                  {exp.period}
                </span>
              </div>
        ...
        >
          <div className="w-14 h-14 rounded-xl bg-white/3 border border-dashed border-white/8 flex items-center justify-center shrink-0">
